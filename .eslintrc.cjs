    ...
    'perfectionist/sort-imports': [
      1,
      {
        ...
        'custom-groups': {
          value: {
            ['custom-mui']: '@mui/**',
            ['custom-auth']: 'resources/js/auth/**',
            ['custom-hooks']: 'resources/js/hooks/**',
            ['custom-utils']: 'resources/js/utils/**',
            ['custom-types']: 'resources/js/types/**',
            ['custom-routes']: 'resources/js/routes/**',
            ['custom-sections']: 'resources/js/sections/**',
            ['custom-components']: 'resources/js/components/**',
          },
        },
        'internal-pattern': ['resources/js/**'],
      },
    ],
  },
};
